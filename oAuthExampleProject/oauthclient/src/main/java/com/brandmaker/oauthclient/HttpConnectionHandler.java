...
public class HttpConnectionHandler
{
	...
	public HttpURLConnection openUrlConnection(String uri) throws MalformedURLException, IOException, URISyntaxException
	{
		return openUrlConnection(uri, "GET");
	}
	/**
	 ...
	 */
	public HttpURLConnection openUrlConnection(String uri, String method) throws MalformedURLException, IOException, URISyntaxException
	{
